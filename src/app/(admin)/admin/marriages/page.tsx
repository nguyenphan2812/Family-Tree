...
import { MarriageForm } from "@/src/features/marriage/components/MarriageForm";
import { AddChildForm } from "@/src/features/marriage/components/AddChildForm";

export default function ManageMarriagesPage() {
  ...
  return (
    <div className="p-8 flex flex-col gap-8">
      <h1 className="text-2xl font-medium">Manage marriages</h1>
      <MarriageForm />
      <AddChildForm />
    </div>
  );
